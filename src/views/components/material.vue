...
// const floorTextures=textureloader.load('./1.jpg')
const floorTextures=textureloader.load('./kenney_particle-pack/PNG (Transparent)/star_02.png')
// 纹理偏移.旋转
// floorTextures.offset.x=0.1
// floorTextures.offset.y=0.2
// 设置纹理中心
floorTextures.center.set(0.5,0.5)
floorTextures.rotation= Math.PI/4
floorTextures.repeat.set(2,3)
// 设置纹理重复模式
floorTextures.wrapS=THREE.MirroredRepeatWrapping
floorTextures.wrapT=THREE.RepeatWrapping
